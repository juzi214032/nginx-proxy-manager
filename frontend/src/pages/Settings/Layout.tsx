...
export default function Layout() {
	...
	const [activeTab, setActiveTab] = useState<"default-site" | "public-port">("default-site");
					...
					<div className="col-12 col-md-3 border-end">
						<div className="card-body mt-0 pt-0">
							<div className="list-group list-group-transparent">
								...
								<a
									href="#"
									className={`list-group-item list-group-item-action d-flex align-items-center${activeTab === "public-port" ? " active" : ""}`}
									onClick={(e) => {
										e.preventDefault();
										setActiveTab("public-port");
									}}
								>
									<T id="settings.public-port" />
								</a>
							</div>
						</div>
					</div>
					<div className="col-12 col-md-9 d-flex flex-column">
						{activeTab === "default-site" ? <DefaultSite /> : <PublicPort />}
					</div>
				</div>
			</div>
		</div>
